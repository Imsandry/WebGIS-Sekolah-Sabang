                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('sekolah.update', $sekolah->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="nama" class="block mt-1 w-full" type="text" name="nama" :value="old('nama', $sekolah->nama)" required autofocus />
                        ...
                        <div class="mb-4">
                            ...
                            <select id="jenjang" name="jenjang" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full" required>
                                ...
                                <option value="Lainnya" {{ old('jenjang', $sekolah->jenjang) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="akreditasi" name="akreditasi" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full" required>
                                ...
                                <option value="Belum Akreditasi" {{ old('akreditasi', $sekolah->akreditasi) == 'Belum Akreditasi' ? 'selected' : '' }}>Belum Akreditasi</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="lat" class="block mt-1 w-full" type="number" step="any" name="lat" :value="old('lat', $sekolah->lat)" required />
                            <x-input-error :messages="$errors->get('lat')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="lng" :value="__('Longitude (Lng)')" />
                            <x-text-input id="lng" class="block mt-1 w-full" type="number" step="any" name="lng" :value="old('lng', $sekolah->lng)" required />
                            <x-input-error :messages="$errors->get('lng')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="npsn" :value="__('NPSN (Opsional)')" />
                            <x-text-input id="npsn" class="block mt-1 w-full" type="text" name="npsn" :value="old('npsn', $sekolah->npsn)" />
                        ...
                        <div class="mb-4">
                            ...
                            @if($sekolah->foto)
                                <div class="mt-2 mb-2">
                                    ...
                                    <img src="{{ asset('images/sekolah/' . $sekolah->foto) }}" alt="Foto {{ $sekolah->nama }}" class="h-24 w-auto object-cover rounded-md">
                                </div>
                            @endif
